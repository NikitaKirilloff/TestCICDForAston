pipeline {
    ...
    environment {
        ...
        LOCAL_WAR_DIR="/var/lib/jenkins/workspace/Test3/target"
        WAR_FILE="test.war"
    }
        ...
        stage('Deploy') {
           steps {
               script {
                   ...
                   sh "scp -i /var/lib/jenkins/.ssh/id_rsa /var/lib/jenkins/workspace/Test3/target/test.war ubuntu@212.22.70.140:/opt/tomcat/webapps/test.war"
